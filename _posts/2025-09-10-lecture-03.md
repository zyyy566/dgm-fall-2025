...
* When the surface is **anisotropic** or *elongated*, gradient updates oscillate and converge slowly.
...
### 3.5 Theoretical Explanations (Multiple Perspectives)
...
* **Alternative Normalization Methods**:
  ...
  * *Instance Normalization* (IN): Across spatial dimensions per sample; often used in style transfer.
  * *Group Normalization* (GN): Across grouped channels; stable for small batches.
...
* **Symmetry** among neurons (if all weights equal).
