...
<d-math block>
f'(x) = \frac{d f}{dx} = \lim\limits_{\Delta x \to 0} \frac{f(x+\Delta x) - f(x)}{\Delta x}
</d-math>
...
<d-math block>
f'(x) = \lim\limits_{\Delta x \to 0} \frac{f(x+\Delta x) - f(x)}{\Delta x} = \lim\limits_{\Delta x \to 0} \frac{2x+2\Delta x-2x}{\Delta x} = 2
</d-math>

- $f(x)=x^2$:

<d-math block>
f'(x) = \lim\limits_{\Delta x \to 0} \frac{f(x+\Delta x) - f(x)}{\Delta x} = \lim\limits_{\Delta x \to 0} \frac{x^2+2x \Delta x+(\Delta x)^2-x^2}{\Delta x} = 2x
</d-math>
...
<d-math block>
f(x) = a x \quad \Rightarrow \quad f'(x) = a
</d-math>

<d-math block>
f(x) = x^a \quad \Rightarrow \quad f'(x) = a x^{a-1}
</d-math>

<d-math block>
f(x) = a^x \quad \Rightarrow \quad f'(x) = \ln(a) a^x
</d-math>
...
- Sum Rule
  <d-math block>
  h(x) = f(x) + g(x) \quad \Rightarrow \quad h'(x) = f'(x) + g'(x)
  </d-math>
...
- Product Rule
  <d-math block>
  h(x) = f(x) g(x) \quad \Rightarrow \quad h'(x) = f'(x) g(x) + f(x) g'(x)
  </d-math>

- Quotient Rule
  <d-math block>
  h(x) = \frac{f(x)}{g(x)} \quad \Rightarrow \quad h'(x) = \frac{f'(x) g(x) - f(x) g'(x)}{g(x)^2}
  </d-math>

- Reciprocal Rule
  <d-math block>
  h(x) = \frac{1}{f(x)} \quad \Rightarrow \quad h'(x) = -\frac{f'(x)}{(f(x))^2}
  </d-math>
...
<d-math block>
\frac{df}{dg}\cdot \frac{dg}{dh} \cdot \frac{dh}{du} \cdot \frac{du}{dv} \cdot \frac{dv}{dx} \quad (\text{reverse mode: start from the outer parts})
</d-math>

<d-math block>
= \frac{dv}{dx} \cdot \frac{du}{dv} \cdot \frac{dh}{du} \cdot \frac{dg}{dh} \cdot \frac{df}{dg} \quad (\text{forward mode: start from the inner parts})
</d-math>
...
<d-math block>
\frac{d}{dx}[f(g(x),h(x))]= 2 g(x) h(x) \cdot 3 + (g(x)^2 + 1) \cdot 2x
</d-math>
...
<p align="center">
  <img src="{{ '/assets/img/notes/lecture-05/Image9.png' | relative_url }}" alt="Perceptron vs ADALINE" width="400"/>
</p>
